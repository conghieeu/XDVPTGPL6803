...
{
    public class Demo_Ragd_CharacterGetupController : MonoBehaviour, RagdollProcessor.IRagdollAnimatorReceiver
    {
        public RagdollAnimator RagdollAnim;
        ...
        int hitsOccured = 0;
        float hitCulldown = 0f;

        public void RagdAnim_OnCollisionEnterEvent( RagdollCollisionHelper hitted )
        {
            ...
            if( RagdollAnim.Parameters.FreeFallRagdoll ) return; // Already ragdolled - don't proceed push impacts (you can do HeathPoints-- in else)
        ...
        void KnockoutImpact( RagdollCollisionHelper hittedBone, Vector3 relativeVelocity )
        {
